...
Compare price variations across countries, grape types, and vintages

Analyze customer review patterns to understand preferences
...
Converting price, quantity, and year into usable numeric formats
...
Older vintages (2000–2009) show much higher pricing
...
Cabernet Sauvignon and Chardonnay-based blends remain highly popular.

Price significantly increases for aged vintages.
...
Automate web scraping with pagination + scheduler
